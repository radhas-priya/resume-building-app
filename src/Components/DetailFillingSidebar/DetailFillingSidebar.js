      ...
      {windowSize.innerWidth > 850 ? (
            ...
            <ListItem disablePadding>
              <ListItemButton
                ...
                <ListItemText
                  ...
                  sx={
                    props.tab === 3
                      ? { color: "rgb(255,251,0)", paddingLeft: "8px" }
                      : null
                  }
                />
              </ListItemButton>
        ...
        <div>
          ...
          <Menu
            ...
            <MenuItem
              sx={props.tab === 0 ? { color: "rgb(255,251,0)" } : null}
              onClick={() => {
                handleClose();
              }}>
              <AccountCircleOutlinedIcon
            ...
            <Divider />
            <MenuItem
              sx={props.tab === 1 ? { color: "rgb(255,251,0)" } : null}
              onClick={() => {
                handleClose();
              }}>
              <WorkHistoryRoundedIcon
            ...
            <Divider />
            <MenuItem
              sx={props.tab === 2 ? { color: "rgb(255,251,0)" } : null}
              onClick={() => {
                handleClose();
              }}>
              <SchoolRoundedIcon
            ...
            <Divider />
            <MenuItem
              sx={props.tab === 3 ? { color: "rgb(255,251,0)" } : null}
              onClick={() => {
                handleClose();
              }}>
