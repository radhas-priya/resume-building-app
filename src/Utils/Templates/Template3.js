  ...
  return (
    <Paper
      ...
      <TemplateHeader
        ...
        bgColor={"#9c9a91"} //green
        personalInfo={personalinfo}
        workExperience={workexperience}
      />
      <Container>
        <TemplateHeading color={"#9c9a91"} title={"Professional Experience"} />
        ...
        <TemplateHeading color={"#9c9a91"}
        title={"Education"}/>
        <TemplateEducationComponent education={educationinfo} />
        <TemplateHeading color={"#9c9a91"} title={"Key Skills"} />
        <ul style={{ marginBottom: 10 }}>
